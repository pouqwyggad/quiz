...
export const HatIcon: FC<PropsWithChildren<HatIconProps>> = ({ className, onClick }) => {
  const handleClick = () => {
    onClick();
  };
    ...
    <button type="button" onClick={handleClick}>
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M21.4 15V9" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </button>
  );
};
